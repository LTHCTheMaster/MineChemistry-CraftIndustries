...
execute if score _defs.checked_version lthc.chemistry._defs matches 0 run tellraw @a ["",{"text": "[MineChemistry CraftIndustries Error: ERROR] MC 1.20.1 is Required","color": "red","bold": true}]
