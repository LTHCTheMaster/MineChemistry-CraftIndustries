...
execute if score _defs.players_present lthc.chemistry._defs matches 1 if score _defs.minecraft_version lthc.chemistry._defs matches 3465.. run scoreboard players set _defs.checked_version lthc.chemistry._defs 1
