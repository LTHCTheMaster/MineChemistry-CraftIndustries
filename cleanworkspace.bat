@echo off
del /Q zip\*.zip
del /Q elementsBuildTest
del /Q elementsBuildTestdust
...
del /Q Datapack\data\lthc.chemistry\loot_tables\i\elements\block\*.json
del /Q Resourcepack\assets\lthc.chemistry\models\elements\*.json
...
del /Q Resourcepack\assets\lthc.chemistry\textures\block\elements\imported\*.png
